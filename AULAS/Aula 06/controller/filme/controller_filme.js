        ...
        if (String(contentType).toUpperCase() == 'APPLICATION/JSON') {
            ...
            if (validar) {
                ...
                if (result) {
                    ...
                    // Manipulação de dados para inserção dos gêneros relacionados ao 
        ...
        if (String(contentType).toUpperCase() == 'APPLICATION/JSON') {
            ...
            if (buscarFilmeResult.status) {
                ...
                if (!validar) {
                    ...
                    if (result) {
                        // Excluir as relações entre o filme e os gêneros
        ...
        if (result) {
            ...
            if (result.length > 0) {
                ...
                for (let filme of result) {
                    ...
                    // Manipulação de dados para retornar todos os gêneros relacionados ao filme
...
const validarDados = async function (filme) {
    ...
    } else if (filme.id_classificacao == undefined || filme.id_classificacao == '' || filme.id_classificacao == null || isNaN(filme.id_classificacao) || filme.id_classificacao < 1) {
