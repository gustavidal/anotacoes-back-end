...
// Import da controller de foto
const controllerFoto = require('../controller/foto/controller_foto.js')

router.post('/v1/senai/locadora/foto', bodyParserJSON, async function (request, response) {
...
router.get('/v1/senai/locadora/foto', async function (request, response) {
...
router.get('/v1/senai/locadora/foto/:id', async function (request, response) {
...
router.put('/v1/senai/locadora/foto/:id', bodyParserJSON, async function (request, response) {
    let contentType = request.headers['content-type']
    let id          = request.params.id
    let dados       = request.body
...
router.delete('/v1/senai/locadora/foto/:id', async function (request, response) {
    let id     = request.params.id
